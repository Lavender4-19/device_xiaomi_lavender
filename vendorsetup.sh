...
git clone --depth=1 https://github.com/Lavender4-19/vendor_xiaomi_lavender.git -b rice13-4.19 vendor/xiaomi/lavender
git clone --depth=1 https://github.com/Lavender4.19/vendor_xiaomi_sdm660-common.git -b 13-4.19 vendor/xiaomi/sdm660-common
