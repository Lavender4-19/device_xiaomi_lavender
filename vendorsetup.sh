...
# dt
git clone --depth=1 https://github.com/OmarAlCoptan/device_xiaomi_sdm660-common.git -b 13-4.19 device/xiaomi/sdm660-common
git clone --depth=1 https://github.com/OmarAlCoptan/vendor_xiaomi_lavender.git -b 13-4.19 vendor/xiaomi/lavender
